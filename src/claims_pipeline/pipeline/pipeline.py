...
from claims_pipeline.pipeline.data_preprocessing.data_preprocessing import preprocess_data
from claims_pipeline.pipeline.model_evaluation.model_evaluation import evaluate_model
from claims_pipeline.pipeline.model_training.cv_training import cv_train_model
from claims_pipeline.pipeline.model_training.initial_training import split_data_train_test, train_model
...
def _step_metadata_init(config: Any) -> tuple[dict, str]:
    ...
    run_dir = f"src/claims_pipeline/pipeline/pipeline.out/{run_dir_folder}"
...
if __name__ == "__main__":
    ...
    best_paramaters = _step_hyperparameter_tuning(
        ...
        model_artifact_dir="src/model_artifacts",
    )
    joblib.dump(best_paramaters, f"src/model_artifacts/best_paramaters.gz", compress=1)
